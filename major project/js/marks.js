...
//                                   status      :  v6,
       ...
       $("div.row1").on("click","a#bt",function(){
              ...
              v4=$("div.row1 input#markso").val();
              v5=$("div.row1 input#tm").val();
			...
			$('div#popupError').popup("open");
                     ...
                     $('div#popupError div#successBody p.errorMessage').text('Please Enter Test name');
			$('div#popupError').popup("open");
              }
              else if(v4===""){
                     $('div#popupError div#successBody p.errorMessage').text('Please Enter Marks obtain');
			$('div#popupError').popup("open");
              }
              else if(v5===""){
                     $('div#popupError div#successBody p.errorMessage').text('Please Enter Total marks');
                      $('div#popupError').popup("open");
              }
              else if(v6===""){
